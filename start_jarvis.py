...
Usage:
    python start_jarvis.py              # Production Mode
    python start_jarvis.py --dev        # Development Mode
    python start_jarvis.py --build      # Build Desktop Binary
"""
...
def start_desktop_production():
    ...
    if system == 'Windows':
        binary = Path('desktop/build/bin/jarvis-desktop.exe')
    elif system == 'Darwin':  # macOS
        binary = Path('desktop/build/bin/jarvis-desktop.app/Contents/MacOS/jarvis-desktop')
    else:  # Linux
        binary = Path('desktop/build/bin/jarvis-desktop')
    
    if not binary.exists():
        logger.error(f"❌ Binary not found: {binary}")
        logger.info("💡 Run: python start_jarvis.py --build")
        return False
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python start_jarvis.py              # Start in production mode (uses binary)
  python start_jarvis.py --dev        # Start in development mode (hot-reload)
  python start_jarvis.py --build      # Build desktop binary
  python start_jarvis.py --backend    # Start backend only
        """
    )
