...
J.A.R.V.I.S. (JarvisCore) ist ein modularer, vollständig lokaler Sprach- und Automationsassistent mit Web- und Desktop-Oberfläche, Spracherkennung, Text-zu-Sprache, Wissensdatenbank, Plugin-System und GPU-beschleunigten LLMs.  
...
- Oberfläche:
  ...
  - Optionale Desktop-GUI (Tkinter/Electron)
- Sicherheit:
  - AES-256 + RSA-4096
...
Mehr in [`docs/usage.md`](./docs/usage.md).
