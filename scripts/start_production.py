#!/usr/bin/env python3
"""
J.A.R.V.I.S. Core - Production Launcher

Startet:
1. Python Backend (API + WebSocket)
2. Desktop UI (Wails Binary)
"""
...
def start_desktop_production():
    ...
    if not binary.exists():
        ...
        logger.info("💡 Run: python scripts/start_production.py --build")
        return False
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='J.A.R.V.I.S. Core Production Launcher',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python scripts/start_production.py           # Start production binary
  python scripts/start_production.py --build   # Build desktop binary
  python scripts/start_production.py --backend # Backend only
        """
    )
    ...
    # Banner
    print("┌" + "─" * 60 + "┐")
    print("│" + " " * 12 + "J.A.R.V.I.S. Core Production" + " " * 12 + "│")
    print("│" + " " * 20 + "v1.0.0" + " " * 33 + "│")
    print("└" + "─" * 60 + "┘")
    print()
    ...
    # Success
    print()
    logger.info("✅ J.A.R.V.I.S. Core is running (Production Mode)!")
    logger.info("🎯 Backend:    http://127.0.0.1:5050")
    logger.info("🎯 WebSocket:  ws://127.0.0.1:8765")
    logger.info("💻 Desktop UI: Running (binary)")
    print()
